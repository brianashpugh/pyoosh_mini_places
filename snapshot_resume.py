...
def minialexnet(data, labels=None, train=False, param=learned_param,
    ...
    n.conv2, n.relu2 = conv_relu(n.pool1, 5, 256, pad=2, group=1, **conv_kwargs)
    n.pool2 = max_pool(n.relu2, 3, stride=2, train=train)
    n.conv3, n.relu3 = conv_relu(n.pool2, 3, 384, pad=1, **conv_kwargs)
    n.conv4, n.relu4 = conv_relu(n.relu3, 3, 384, pad=1, group=1, **conv_kwargs)
    n.conv5, n.relu5 = conv_relu(n.relu4, 3, 256, pad=1, group=1, **conv_kwargs)
...
def train_net(with_val_net=False):
    ...
    solver.restore('snapshot/place_net_iter_10000.solverstate');
